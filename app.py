...
''')
txt4('ABC Mobile Store','Our team has built a website selling electronic devices such as mobile phones, tablets for ABC mobile store. Using `Angular` framework, `Eclipse`, `MySQL`, ... to build this entire website system. My role: Front-end Developer.','https://gitlab.com/abc334/abc-ms_abc-mobile-store')
